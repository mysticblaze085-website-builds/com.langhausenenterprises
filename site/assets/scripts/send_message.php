...
$to = "langhausen.enterprises@gmail.com, rayvendesigns@gmail.com"; //Replace with recipient email address
...
// Additional headers
$headers[] = 'From: ' .$email;
$headers[] = 'To: Terry <terry.langhausen@gmail.com>, Melissa <rayvendesigns@gmail.com>';
...
//$sentMail = true;
if (!$sentMail) {
    $output = json_encode(array('type' => 'error', 'text' => 'Could not send mail! Please contact Terry Langhausen 469-233-4765.'));
    die($output);
} else {
    $output = json_encode(array('type' => 'message', 'text' => 'Hello! ' . $full_name . ' Thank you for your interest, Terry will contact you shortly.'));
    die($output);
}
}
 ?>